...
def init_bridge():
    ...
    for i in range(number_of_segments):
        print(i)
        members.append(BridgeMember((((spacing+WINDOW_WIDTH)/number_of_segments)*i, y_pos), WINDOW_WIDTH/number_of_segments-spacing/2, 30))
    return members
    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            if event.key == pygame.K_SPACE:
                ...
                x_pos = random.randint(20, WINDOW_WIDTH-20)
